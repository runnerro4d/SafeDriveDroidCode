...
public class NavigationActivity extends AppCompatActivity  implements OnMapReadyCallback {
    ...
    private TextView restStopID;
    private TextView toilet;
    private TextView water;
    private TextView wheelChair;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //-39.234713, 140.962526
        //-33.981125, 149.975296
...
//                String s = markerOptions.getSnippet();
//                String[] restStop =  s.split(",");
//                restStopID = findViewById(R.id.RestStopID);
//
//                restStopID.setText(s);
//
//
//                return true;
//            }
...
//                    startActivity(mapIntent);
        ...
        disabledToiletfab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edit.commit();
                Toast.makeText(NavigationActivity.this, "preference Saved! Disabled Toilet - " + status, Toast.LENGTH_LONG).show();
...
//                        .setAction("Action", null).show();
        ...
        fastFoodfab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edit.commit();
                Toast.makeText(NavigationActivity.this, "preference Saved! Fast Food - " + status, Toast.LENGTH_LONG).show();
...
//                        .setAction("Action", null).show();
        ...
        toiletfab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edit.commit();
                Toast.makeText(NavigationActivity.this, "preference Saved! Toilet - " + status, Toast.LENGTH_LONG).show();
...
//                        .setAction("Action", null).show();
        ...
        picnicTablefab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edit.commit();
                Toast.makeText(NavigationActivity.this, "preference Saved! Picnic Table - " + status, Toast.LENGTH_SHORT).show();
//                Snackbar.make(view, "preference Saved: Picnic Table - " + status, Snackbar.LENGTH_LONG)
//                        .setAction("Action", null).show();
            }
        });
    }
    ...
    public void startRoute(LatLng origin, LatLng destination, boolean placesApi ){
            ...
            if(placesApi) {
                mMap.addMarker(new MarkerOptions()
                        ...
                        .title("Destination")
                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.dest_flag)));
            }
